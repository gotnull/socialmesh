...
final List<RegionMetadata> kRegionMetadata = <RegionMetadata>[
  ...
  RegionMetadata(
    code: config_pbenum.Config_LoRaConfig_RegionCode.ITU1_70CM,
    frequency: '430-440MHz',
    dutyCycle: 100,
    isCountry: false,
    radioConfigLabel: (l) => l.regionSelectionRegionItu1_70cm,
    regionSelectionName: (l) => l.regionSelectionRegionItu1_70cm,
    regionSelectionFrequency: (l) => l.regionSelectionRegionItu1_70cmFreq,
    regionSelectionDescription: (l) => l.regionSelectionRegionItu1_70cmDesc,
  ),
  RegionMetadata(
    code: config_pbenum.Config_LoRaConfig_RegionCode.ITU2_70CM,
    frequency: '420-450MHz',
    dutyCycle: 100,
    isCountry: false,
    radioConfigLabel: (l) => l.regionSelectionRegionItu2_70cm,
    regionSelectionName: (l) => l.regionSelectionRegionItu2_70cm,
    regionSelectionFrequency: (l) => l.regionSelectionRegionItu2_70cmFreq,
    regionSelectionDescription: (l) => l.regionSelectionRegionItu2_70cmDesc,
  ),
  RegionMetadata(
    code: config_pbenum.Config_LoRaConfig_RegionCode.ITU3_70CM,
    frequency: '430-450MHz',
    dutyCycle: 100,
    isCountry: false,
    radioConfigLabel: (l) => l.regionSelectionRegionItu3_70cm,
    regionSelectionName: (l) => l.regionSelectionRegionItu3_70cm,
    regionSelectionFrequency: (l) => l.regionSelectionRegionItu3_70cmFreq,
    regionSelectionDescription: (l) => l.regionSelectionRegionItu3_70cmDesc,
  ),
  RegionMetadata(
    code: config_pbenum.Config_LoRaConfig_RegionCode.ITU2_125CM,
    frequency: '220-225MHz',
    dutyCycle: 100,
    isCountry: false,
    radioConfigLabel: (l) => l.regionSelectionRegionItu2_125cm,
    regionSelectionName: (l) => l.regionSelectionRegionItu2_125cm,
    regionSelectionFrequency: (l) => l.regionSelectionRegionItu2_125cmFreq,
    regionSelectionDescription: (l) => l.regionSelectionRegionItu2_125cmDesc,
  ),
];
