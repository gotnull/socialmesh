...
class VSNodeManager {
  ...
  ///
  /// Creates an instance of VSNodeSerializationManager to handle
  /// serializations.
  VSNodeManager({
  ...
  /// Calls serializationManager.serializeNodes with the current node data and
  /// returns a String.
  ...
  void updateOrCreateNodes(List<VSNodeData> nodeDatas) {
