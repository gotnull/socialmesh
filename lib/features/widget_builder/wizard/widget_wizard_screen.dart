  ...
  List<_ActionOption> _getAvailableActions() {
    return [
      _ActionOption(
        ...
        label: context.l10n.widgetBuilderActionSendMessageLabel,
      ...
      _ActionOption(
        ...
        label: context.l10n.widgetBuilderActionShareLocationLabel,
      ...
      _ActionOption(
        ...
        label: context.l10n.widgetBuilderActionRequestPositionsLabel,
      ...
      _ActionOption(
        ...
        label: context.l10n.widgetBuilderActionTracerouteLabel,
      ...
      _ActionOption(
        type: ActionType.sos,
        label: context.l10n.widgetBuilderActionSosAlert,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: context.l10n.widgetBuilderLabelHintExample,
                        hintStyle: TextStyle(color: context.textSecondary),
                        filled: true,
                        fillColor: context.surface,
                        border: OutlineInputBorder(
